...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="col-8 col-md-8 mx-auto mt-2 mb-5" style="min-height: 480px;">
                <?php 
                 echo SuccessMessage();
                 echo ErrorMessage();
                ?>
                        ...
                        <table id="my-table" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlentities($Quantity) ?>
                                    <td><a href="edit_product.php?id=<?php echo $Id ?>"
                                                class="btn btn-sm btn-success">Edit</a>&nbsp;<a
                                            href="del_product.php?id=<?php echo $Id ?>"
