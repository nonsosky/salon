...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-lg-3 mx-auto my-2">
                    <div class="card bg-gray justify-content-center">
                        <div class="card-body text-uppercase font-weight-bold text-center">
                            <span class="d-block text-center">Sales</span>
                            <span class=""><?php echo TotalRecords() ?></span>
                        </div>
                        <div class="card-footer text-right">
                            <a href="Dashboard.php" class="ux-btn-ghost">
                                Refresh
                ...
                <div class="col-12 col-sm-6 col-lg-3 mx-auto my-2">
                    <div class="card bg-gray justify-content-center">
                        <div class="card-body text-uppercase font-weight-bold text-center">
                            ...
                            <span class=""><?php echo TotalStaff() ?></span>
                        </div>
                        <div class="card-footer text-right">
                            <a href="Dashboard.php" class="ux-btn-ghost">
                                Refresh
                ...
                <div class="col-12 col-sm-6 col-lg-3 mx-auto my-2">
                    <div class="card bg-gray justify-content-center">
                        <div class="card-body text-uppercase font-weight-bold text-center">
                            <span class="d-block text-center">Product</span>
                            <span class=""><?php echo TotalProducts()?></span>
                        </div>
                        <div class="card-footer text-right">
                            <a href="Dashboard.php" class="ux-btn-ghost">
                                Refresh
                ...
                <div class="col-12 col-sm-6 col-lg-3 mx-auto my-2">
                    <div class="card bg-gray justify-content-center">
                        <div class="card-body text-uppercase font-weight-bold text-center">
                            ...
                            <span class=""><?php echo TotalAdmins() ?></span>
                        </div>
                        <div class="card-footer text-right">
                            <a href="Dashboard.php" class="ux-btn-ghost">
                                Refresh
        ...
        <div class="row">
            <div class="col-9 col-sm-9 col-lg-9 mx-auto my-2">
                <div class="card mt-5">
                    <div class="card-header">
                        <h5>Today Sales Record</h5>
                    </div>
                    <div class="card-body scrollable" style="max-height: 55vh; overflow-y: scroll">
                        <table id="my-table" class="table table-striped table-bordered table-hover">
                            ...
                            <?php
                                $SRNO = 0;
                                global $ConnectingDB;
                                $sql = "SELECT * FROM records WHERE date(date) = CURDATE()";
