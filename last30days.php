...
<head>
    ...
    <title>Last 30 Days Sales</title>
</head>
<body>
            ...
            <div class="col-8 col-sm-8 col-lg-8 mx-auto my-2" style="min-height:530px;">
                <div class="card mt-5">
                    <div class="card-header">
                        <h4>Last 30days Sales Record</h4>
                    </div>
                    <div class="card-body scrollable" style="max-height: 55vh; overflow-y: scroll">
                        <table id="my-table" class="table table-striped table-bordered table-hover">
                            ...
                            <?php
                                $SRNO = 0;
                                global $ConnectingDB;
                                $sql = "SELECT * FROM records WHERE date = CURDATE() - INTERVAL 30 DAY";
                        ...
                        <div class="text-center font-weight-bold">
                            <span id="Total">Total Amount: <?php echo TotalAmountLast30days() ?></span>
                        </div>
                    </div>
                </div>
            </div>
