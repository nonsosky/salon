...
if(isset($_POST["submit"])){
    ...
    if(empty($Product_Name)||empty($Price)||empty($Stock)){
        ...
        global $ConnectingDB;
        $sql = "INSERT INTO products(datetime, product_name, price, quantity)
                VALUES(:dateTime, :proDuct, :priCe, :stocK)";
                    ...
                    <div class="col-6 col-sm-6 col-lg-6 mx-auto my-2">
                        ...
                        <form action="add_product.php" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="product_name" name="product_name" placeholder="eg. hair dryer, shampo">
                            </div>
                            <div class="form-group">
                                <label for="price">Price</label>
                                <input type="text" class="form-control" id="price" name="price" placeholder="eg. 5000">
                            </div>
                            <div class="form-group">
                                <label for="stock">Stock</label>
                                <input type="number" class="form-control" id="stock" min="0" name="stock">
                            </div>
